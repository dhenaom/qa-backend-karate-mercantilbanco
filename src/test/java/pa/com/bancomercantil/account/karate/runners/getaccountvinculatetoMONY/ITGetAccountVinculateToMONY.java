package pa.com.bancomercantil.account.karate.runners.getaccountvinculatetoMONY;
...
public class ITGetAccountVinculateToMONY {
    @Karate.Test
    Karate getCurrentAccountFailureTest() throws IOException {
        String timestamp = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
        String path = "target/karate-reports-"+timestamp;
        Karate result = Karate.run("classpath:pa/com/bancomercantil/account/karate/getaccountvinculatetoMONY/features/getaccountvinculatetoMONY.feature")
