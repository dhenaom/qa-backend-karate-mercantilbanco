...
public class ITGetStatusCurrentAccountSuccessRunner {

            @Karate.Test
            Karate getStatusCurrentAccountSuccessTest() throws IOException {
                String timestamp = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
                String path = "target/karate-reports-"+timestamp;
                Karate result = Karate.run("classpath:pa/com/bancomercantil/account/karate/getstatusaccount/features/statuscurrentaccountsuccess.feature")
