...
public class ITAuthenticationEvaluateFailureRunner {
    @Karate.Test
    Karate authenticationEvaluateFailureTest() throws IOException {
        String timestamp = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss").format(new Date());
        String path = "target/karate-reports-"+timestamp;
        Karate result = Karate.run("classpath:pa/com/bancomercantil.authentication/karate/validatechallenge/features/validatechallengefailure.feature")
